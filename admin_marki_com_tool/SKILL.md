...
description: 用于查询马克智慧物业系统数据的工具，当用户询问任何与小区物业收费、欠费、收入、支出、收缴率、用户信息、发送微信缴费提醒等相关的问题时，都应该使用这个工具。具体功能包括：查看加入的团队列表、登出账号，查询小区欠费总额、查询小区物业费欠费情况、查询本年度物业费欠费、查询自定义时间范围的欠费，查询今日收入统计（总收入、现金收入、预存款充值、押金收取、缴费笔数、各收费项/支付方式/收款员的收入情况），查询本月小区总支出，查询本月小区房屋收缴率，查询截至当前小区欠费总户数，查询某一栋楼/某一单元/某一间房屋的欠费总额，查询当前登录用户信息，以及发送微信缴费提醒给小区所有业主。当用户提到马克物业、小区欠费、收费项目、团队列表、本年度物业费、自定义时间欠费、今日收入、缴费统计、本月支出、小区支出、收缴率、房屋收缴率、欠费户数、欠费总户数、楼栋欠费、单元欠费、房屋欠费、当前用户信息、登录用户信息、小区收费情况、物业欠费、收了多少钱、花了多少钱、缴费率、微信提醒、缴费提醒、发送提醒等相关内容时，记得使用这个工具。
requires:
  bins:
